...
COPY --from=builder --chown=${PUID}:${PGID} /home/${UNAME} /home/${UNAME}
COPY --from=builder /opt/retropie /opt/retropie
COPY --from=builder /etc/emulationstation /etc/emulationstation
COPY --from=builder /usr/bin/emulationstation /usr/bin/emulationstation
