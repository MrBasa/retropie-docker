...
# Pre-create directories that will be used as volume mount points
RUN mkdir -p /home/pie/.emulationstation /home/pie/RetroPie/{roms,BIOS,saves,states}
...
# Create a backup of the default configurations that were generated by the setup script.
